...
import com.akhi.islamiclikee.Model.Password;
import com.akhi.islamiclikee.Model.Users;
import com.akhi.islamiclikee.Model.privatedetails;
import com.akhi.islamiclikee.ReusableCode.ReusableCodeForAll;
...
//lottieAnimation
        lottieAnimationView=findViewById(R.id.txtcreate);
        lottieAnimationView.animate().translationY(1).setDuration(10000).setStartDelay(4000);
