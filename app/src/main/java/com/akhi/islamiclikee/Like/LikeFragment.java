package com.akhi.islamiclikee.Like;
...
import com.akhi.islamiclikee.Adapter.LikeNotificationAdapter;
...
public class LikeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        likeNotificationAdapter = new LikeNotificationAdapter(getContext(), (List<com.akhi.islamiclikee.Model.Notification>) likeNotificationAdapter);
    ...
    private void readNotifications() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Notifications")
                .child(String.valueOf(firebaseUser));
