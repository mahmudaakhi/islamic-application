...
import com.akhi.islamiclikee.Utils.SearchUsersAdapter;
...
public class FollowersFollowing extends AppCompatActivity {
    ...
    private void getFollowings() {
        ...
        com.google.firebase.database.DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Following").child(id);
    ...
    private void getFollowers() {
        ...
        com.google.firebase.database.DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Followers").child(id);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                idList.clear();
    ...
    private void showUsers() {
        ...
        com.google.firebase.database.DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users");
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                usersList.clear();
