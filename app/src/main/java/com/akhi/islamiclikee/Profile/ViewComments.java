...
import com.akhi.islamiclikee.Adapter.CommentListAdapter;
...
public class ViewComments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.google.firebase.database.DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Users").child(userid);
